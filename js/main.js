...
function createCards(prods){
    prods.forEach(prod => {
        ...
        `
            ...
            <div class="card my-3" style="width: 20rem; height:40rem;">
                <img src="${prod.image}" class="card-img-top img-thumbnail" alt="${prod.description}" style="height:20rem; width:auto;">
            <div class="card-body">
